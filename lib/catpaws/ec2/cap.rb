...
Capistrano::Configuration.instance(:must_exist).load do
  ...
  namespace :EC2 do 
    ...
    #we need to fix this - it isn't idempotent. 
    #as it stands, it requires start to create the instances.
    #we should add a 'no_new' arg to instances os we can fetch but not create
